...
latex_elements = {"papersize": "a4paper", "pointsize": "10pt", "preamble": "", "figure_align": "htbp"}
latex_documents = [(master_doc, "apostello.tex", "apostello Documentation", "Dean Montgomery", "manual")]
# latex_logo = None
