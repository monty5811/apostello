...
meta =
    ...
    , auto_name_request = FieldMeta False "id_auto_name_request" "auto_name_request" "Auto name request" (Just "Message to send when we first receive a message from someone not in the contacts list.")
