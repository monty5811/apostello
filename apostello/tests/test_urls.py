...
class TestOthers:
    ...
    def test_new_group(self, users):
        users['c_staff'].post('/group/new/', {'name': 'test_group', 'description': 'this is a test'})
    ...
    def test_bring_group_from_archive(self, groups, users):
        users['c_staff'].post('/group/new/', {'name': 'Archived Group', 'description': 'this is a test'})
    ...
    def test_invalid_group_form(self, users):
        resp = users['c_staff'].post('/group/new/', {'name': '', 'description': 'this is a test'})
        assert 'This field is required.' in str(resp.content)
    ...
    def test_keyword_responses_archive_all_ticked(self, keywords, smsin, users):
        users['c_staff'].post(
            '/keyword/responses/{}/'.format(keywords['test'].pk), {'tick_to_archive_all_responses': True}
        )
