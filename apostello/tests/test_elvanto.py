...
class TestApi:
    ...
    def test_fetch_elvanto_groups(self):
        ...
        assert ElvantoGroup.objects.get(e_id='4ad1c22b-d3c5-11e4-95ba-068b656294b7').name == 'England'
        assert ElvantoGroup.objects.get(e_id='50343ad0-d3c5-11e4-95ba-068b656294b7').name == 'Scotland'
        assert ElvantoGroup.objects.get(e_id='549f2473-d3c5-11e4-95ba-068b656294b7').name == 'Empty'
        assert ElvantoGroup.objects.get(e_id='7ebd2605-d3c7-11e4-95ba-068b656294b7').name == 'All'
