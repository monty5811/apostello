...
import Models.GroupComposer exposing (GroupComposerModel, QueryOp(..), Query, ParenLoc)
import Models.Apostello exposing (RecipientGroup, GroupPk, nullGroup, RecipientSimple)
...
buildGroupLink : List RecipientSimple -> String
