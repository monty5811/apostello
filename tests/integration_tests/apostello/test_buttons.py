...
class TestButton:
    ...
    @pytest.mark.parametrize("uri,query_set", [
    ...
    def test_archive_all(self, uri, query_set, live_server, browser_in, users, keywords, recipients, groups, smsin):
        # load page
    ...
    def test_keyword_resp_table_archive(self, live_server, browser_in, users, keywords, recipients, groups, smsin):
        uri = keywords['test'].get_responses_url
        query_set = models.SmsInbound.objects.filter(matched_keyword='test')
        self.test_archive_all(uri, query_set, live_server, browser_in, users, keywords, recipients, groups, smsin)
    ...
    def test_display_on_wall_toggle(self, live_server, browser_in, users, smsin):
    ...
    def test_keyword_resp_table_dealt_with(self, live_server, browser_in, users, smsin, keywords):
