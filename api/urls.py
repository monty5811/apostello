...
urlpatterns = [
    ...
    url(
        ...
        v.UserCollection.as_view(
            model_class=User, serializer_class=s.UserSerializer, permission_classes=(IsAuthenticated, p.CanSeeKeywords)
        ),
        name="users",
    ),
    url(r"^v2/config/$", v.ConfigView.as_view(), name="site_config"),
    url(r"^v2/responses/$", v.ResponsesView.as_view(), name="default_responses"),
    # simple toggle views:
    url(
    ...
    # action views:
    url(r"^v2/actions/sms/send/adhoc/$", v.SendAdhoc.as_view(), name="act_send_adhoc"),
    url(r"^v2/actions/sms/send/group/$", v.SendGroup.as_view(), name="act_send_group"),
    url(
    ...
    url(r"^v2/actions/group/create_all/$", v.CreateAllGroup.as_view(), name="act_create_all_group"),
    url(r"^v2/actions/sms/permanent_delete/$", v.TwilioDelete.as_view(), name="act_permanent_delete"),
    # api setup
