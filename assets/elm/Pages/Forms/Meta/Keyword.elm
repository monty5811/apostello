...
meta =
    ...
    , custom_response_new_person = FieldMeta False "id_custom_response_new_person" "custom_response_new_person" "Auto response used when the contact is new" (Just "This text will be sent back as a reply when any incoming message matches this keyword and the contact is new. If empty, the normal custom response will be used.")
