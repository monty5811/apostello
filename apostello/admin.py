...
class KeywordAdmin(admin.ModelAdmin):
    ...
    list_display = (
        'keyword', 'is_live', 'activate_time', 'deactivate_time', 'description', 'custom_response',
        'deactivated_response', 'too_early_response', 'is_archived',
    )
...
class RecipientAdmin(admin.ModelAdmin):
    ...
    list_display = ('full_name', 'number', 'is_blocking', 'is_archived', 'do_not_reply', )
