...
def recipients():
    ...
    knox = Recipient.objects.create(first_name="John",
                                    ...
                                    number='+447928401745',
                                    is_archived=True)
    wesley = Recipient.objects.create(first_name="John",
                                      last_name="Wesley",
                                      number='+447927401745',
                                      is_blocking=True)
    john_owen = Recipient.objects.create(first_name="John",
                                         last_name="Owen",
                                         number='+15005550004')  # blacklisted magic num
    thomas_chalmers = Recipient.objects.create(first_name="Thomas",
                                               last_name="Chalmers",
                                               number='+15005550009')  # can't recieve
...
def groups(recipients):
    ...
    archived_group = RecipientGroup.objects.create(name="Archived Group",
                                                   description="This is a test group",
                                                   is_archived=True
                                                   )
    archived_group.save()
    empty_group = RecipientGroup.objects.create(name="Empty Group",
