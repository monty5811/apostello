module Update.KeyRespTable exposing (update)
...
import Update.DataStore exposing (updateSmsInbounds, optArchiveRecordWithPk)
import Urls
...
toggleSmsArchive csrftoken isArchived pk =
    archivePost csrftoken (Urls.smsInbound pk) isArchived decodeSmsInbound
