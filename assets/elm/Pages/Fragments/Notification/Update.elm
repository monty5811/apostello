...
addListOfDjangoMessagesNoDestroy : List DjangoMessage -> Model -> Model
addListOfDjangoMessagesNoDestroy msgs model =
    List.foldl createFromDjangoMessageNoDestroy model msgs
